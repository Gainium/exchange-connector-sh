...
import { RestClientType } from 'bitget-api/lib/types'
...
import {
  ...
  serializeParams,
  getRestBaseUrl,
} from 'bitget-api/lib/util/requestUtils'
import { neverGuard } from 'bitget-api/lib/util/websocket-util'
